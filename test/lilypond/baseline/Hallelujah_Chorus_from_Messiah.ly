...
%% 90
                ...
                \new Lyrics
                \with {alignBelowContext="track 14, Soprano"}
                \lyricsto "voice 13.0" {
                    \lyricmode {
...
%% 90
                ...
                % cycle 1   verse line 1
                \new Lyrics
                \with {alignBelowContext="track 15, Alto"}
                \lyricsto "voice 14.0" {
                    \lyricmode {
                        \override LyricText.self-alignment-X = #LEFT
                        \set ignoreMelismata = ##t
...
%% 90
                ...
                % cycle 1   verse line 1
                \new Lyrics
                \with {alignBelowContext="track 16, Tenore"}
                \lyricsto "voice 15.0" {
                    \lyricmode {
                        \override LyricText.self-alignment-X = #LEFT
                        \set ignoreMelismata = ##t
...
%% 90
                ...
                % cycle 1   verse line 1
                \new Lyrics
                \with {alignBelowContext="track 17, Basso"}
                \lyricsto "voice 16.0" {
                    \lyricmode {
                        \override LyricText.self-alignment-X = #LEFT
                        \set ignoreMelismata = ##t
