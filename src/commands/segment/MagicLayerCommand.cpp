...
MagicLayerCommand::MagicLayerCommand(Segment *segment, Composition &composition):
        NamedCommand(tr("Move Selected Events to New Layer")),
        m_segment(segment),
        m_composition(composition),
        m_detached(false)
{}

MagicLayerCommand::~MagicLayerCommand()
{
    if (m_detached) {
        delete m_segment;
    }
...
Segment *
MagicLayerCommand::getSegment() const
{
    return m_segment;
}

void
MagicLayerCommand::execute()
{ 
    if (!m_segment) return;
